...
状態: **完了（2026-09-21）**。フェーズ 1（受け入れ条件 A）と フェーズ 2（B1〜B4）をどちらも満たし、計画は [`docs/plans/completed/cross-env.md`](../plans/completed/cross-env.md) へ畳んだ。**Windows × Codex の象限は当初から範囲外**で、埋めるなら受け入れ条件を足すこと。
